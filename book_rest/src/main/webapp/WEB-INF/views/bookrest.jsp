...
<body>
	<div class="container">
		...
		<button type="button" id="remove">도서 정보 수정</button>
			...
			$.getJSON({
				...
				success:function(data){
					...
					$.each(data,function(idx,element){
						str += "<tr><td>";
						str += element.code+"</td><td>"+element.title+"</td>";
						str += element.writer+"</td><td>"+element.price+"</td>";
						str += "</tr>";
					})
	...
	$("#modify").click(function(){
		...
		//JSON.stringify() : client 측에서 서버로 데이터를 보낼떄 사용
		//					자바스크립트 객체를 json 형태로 변환시켜서 전송

...
$(function(){
	...
	function showUploadedFile(uploadResultArr){
		...
		$(uploadResultArr).each(function(i,obj){
			if(obj.fileType){ //image
				...
				str+="<li data-path='"+objj.uploadPath+"'data-uuid'"+obj.uuid+"'";
	...
	$("button[type='submit']").click(function(e){
		...
		$(".uploadResult ul li").each(function(idx,obj){
			...
			str+="<input type='hidden' name='attachList["+idx+"].uuid' value'"+job.data("path")+"'>";
			str+="<input type='hidden' name='attachList["+idx+"].uuid' value'"+job.data("filename")+"'>";
			str+="<input type='hidden' name='attachList["+idx+"].uuid' value'"+job.data("type")+"'>";
		})

...
public class FileCheckTask {
	...
	public void checkFiles() {
		...
		//List<Path> => c:\\upload\\2021\\06\\20\\deijifjigij2djksf_1.jpg
		
		// 데이터베이스 기준의 파일 목록을 기준으로 썸네일 이미지 경로를 추출하여
		// 데이터베이스 파일 목록에 추가한다.
		oldList.stream()
		...
		//2.targetDir 에 접근 후 파일 목록 가져온 후 데이터베이스 파일 목록과 일치하지 않는다면
		//  removeFiles 에 추가
		...
		File[] removeFile = targetDir.listFiles();
	}
}
